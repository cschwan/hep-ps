...
TEST_CASE("test partons_in_initial_state_set", "[initial_state]")
{
    ...
    hep::initial_state_set set{
        hep::initial_state::cq_cq, hep::initial_state::cq_cx, hep::initial_state::cq_dq,
        hep::initial_state::cq_dx, hep::initial_state::cq_gl, hep::initial_state::cq_ph,
        hep::initial_state::cq_sq, hep::initial_state::cq_sx, hep::initial_state::cq_uq,
        hep::initial_state::cq_ux, hep::initial_state::cx_cq, hep::initial_state::cx_dx,
        hep::initial_state::cx_sx, hep::initial_state::cx_uq, hep::initial_state::dq_cq,
        hep::initial_state::dq_dx, hep::initial_state::dq_sx, hep::initial_state::dq_uq,
        hep::initial_state::dx_cq, hep::initial_state::dx_cx, hep::initial_state::dx_dq,
        hep::initial_state::dx_dx, hep::initial_state::dx_gl, hep::initial_state::dx_sq,
        hep::initial_state::dx_sx, hep::initial_state::dx_uq, hep::initial_state::dx_ux,
        hep::initial_state::gl_cq, hep::initial_state::gl_dx, hep::initial_state::gl_gl,
        hep::initial_state::gl_sx, hep::initial_state::gl_uq, hep::initial_state::ph_cq,
        hep::initial_state::ph_ph, hep::initial_state::ph_uq, hep::initial_state::sq_cq,
        hep::initial_state::sq_dx, hep::initial_state::sq_sx, hep::initial_state::sq_uq,
        hep::initial_state::sx_cq, hep::initial_state::sx_cx, hep::initial_state::sx_dq,
        hep::initial_state::sx_dx, hep::initial_state::sx_gl, hep::initial_state::sx_sq,
        hep::initial_state::sx_sx, hep::initial_state::sx_uq, hep::initial_state::sx_ux,
        hep::initial_state::uq_cq, hep::initial_state::uq_cx, hep::initial_state::uq_dq,
        hep::initial_state::uq_dx, hep::initial_state::uq_gl, hep::initial_state::uq_ph,
        hep::initial_state::uq_sq, hep::initial_state::uq_sx, hep::initial_state::uq_uq,
        hep::initial_state::uq_ux, hep::initial_state::ux_cq, hep::initial_state::ux_dx,
        hep::initial_state::ux_sx, hep::initial_state::ux_uq,
    };
