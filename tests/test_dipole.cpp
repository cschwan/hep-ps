...
TEST_CASE("test dipole members", "[dipole]")
{
    ...
    hep::dipole dipole1{0, 4, 1, fermion, boson, fermion, hep::correction_type::ew};
    ...
    hep::dipole dipole2{0, 4, 2, fermion, boson, fermion, hep::correction_type::ew};
    ...
    hep::dipole dipole3{0, 4, 3, fermion, boson, fermion, hep::correction_type::ew};
    ...
    hep::dipole dipole4{1, 4, 0, fermion, boson, fermion, hep::correction_type::ew};
    ...
    hep::dipole dipole5{1, 4, 2, fermion, boson, fermion, hep::correction_type::ew};
    ...
    hep::dipole dipole6{1, 4, 3, fermion, boson, fermion, hep::correction_type::ew};
    ...
    hep::dipole dipole7{2, 4, 0, fermion, boson, fermion, hep::correction_type::ew};
    ...
    hep::dipole dipole8{2, 4, 1, fermion, boson, fermion, hep::correction_type::ew};
    ...
    hep::dipole dipole9{2, 4, 3, fermion, boson, fermion, hep::correction_type::ew};
